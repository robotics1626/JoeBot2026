...
public class ShooterIOTalon implements ShooterIO {
    ...
    public ShooterIOTalon() {
        mShooterLeader = new TalonFX(ShooterConstants.Motors.kShooterLeader, "rio");
        mShooterFollower = new TalonFX(ShooterConstants.Motors.kShooterFollower, "rio");
        mShroudController = new TalonFX(ShooterConstants.Motors.kShroud, "rio");
        ...
        shooterFollowerConfigurator.apply(BaseShooterConfigs.withMotorOutput(BaseShooterConfigs.MotorOutput.withInverted(InvertedValue.CounterClockwise_Positive)));
    ...
    public void setSpeed(double precent) {
        ...
        mShooterFollower.setControl(new Follower(mShooterLeader.getDeviceID(), MotorAlignmentValue.Opposed)); // ag - is there another method where i dont have to set control?
    }
    ...
    public void setSpeedRPM(double rpm) {
        ...
        mShooterFollower.setControl(new Follower(mShooterLeader.getDeviceID(), MotorAlignmentValue.Opposed));
    }
    ...
    public void setShroud(double degrees) {
        var request = new PositionVoltage(Angle.ofRelativeUnits(degrees, Degrees));
